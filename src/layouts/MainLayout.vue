...
export default {
  ...
  setup() {
    ...
    const { injectStructuredData, getOrganizationData, getWebApplicationData, getWebSiteData } =
      useStructuredData()
    ...
    injectStructuredData([getOrganizationData(), getWebApplicationData(), getWebSiteData()])
