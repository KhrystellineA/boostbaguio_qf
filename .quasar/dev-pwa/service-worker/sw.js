...
registerRoute(/\.(?:png|gif|jpg|jpeg|svg|webp)$/, new CacheFirst({
...
registerRoute(/^https:\/\/firebasestorage\.googleapis\.com\/.*/i, new NetworkFirst({
...
registerRoute(/^https:\/\/.*\.firebaseio\.com\/.*/i, new NetworkFirst({
